...
class acf_css_gradient_picker extends acf_field {
	...
	*/
	...
	function __construct( $settings )
	{
		...
		$this->label = __('Gradient Picker');
		$this->category = __("Choice",'acf-gradient-picker'); // Basic, Content, Choice, etc
		$this->defaults = array(
...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	<td class="label">
		<label><?php _e("Preview Size",'acf-gradient-picker'); ?></label>
		<p class="description"><?php _e("Thumbnail is advised",'acf-gradient-picker'); ?></p>
	</td>
	<td>
		<?php
		...
		do_action('acf/create_field', array(
			...
			'layout'	=>	'horizontal',
			'choices'	=>	array(
				'thumbnail' => __('Thumbnail', 'acf-gradient-picker'),
				'something_else' => __('Something Else', 'acf-gradient-picker'),
			)
		));
